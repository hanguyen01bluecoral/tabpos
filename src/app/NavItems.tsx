         ...
         <label className="radio-container">
            ...
            <span className="radio-label flex">
              <div className="flex items-center">
                    ...
                    <div className="w-full ml-[6px] text-[12px] px-[6px] bg-[#CCC] rounded-[40%]">
                      12
                    </div>
              </div>
            </span>

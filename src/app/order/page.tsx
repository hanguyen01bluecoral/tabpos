...
export default function OderPaid() {
  ...
  const showTable = () => {
    setTableVisible((prevIshd) => !prevIshd);
  };
      ...
      <div className=" pt-[30px] h-screen ml-[1%] flex-grow ">
        ...
        <div className="w-[370px] h-[389px] mt-[15px] bg-zinc-100 rounded border border-zinc-100 flex-col justify-start items-start gap-px inline-flex">
          {/* <Popover>
            ...
            <PopoverContent className="w-[785px] h-[928px] ">
              <div>
                
                <div className="w-[785px] h-[209px] p-5 bg-slate-200 flex-col justify-start items-start gap-[15px] inline-flex">
                  <div className="w-[745px] justify-between items-start inline-flex">
                ...
                <div className="w-[785px] h-[530px] overflow-y-auto scrollbar-thin">
                  <div className="w-[745px] h-[60px] bg-white justify-start items-start gap-2.5 inline-flex ml-5 mt-6">
                    <img
                  ...
                  <div className="w-[745px] h-px bg-zinc-100 ml-5 mt-[15px]" />
                  <div className="w-[745px] h-[60px] bg-white justify-start items-start gap-2.5 inline-flex ml-5 mt-6">
                    <img
                      className="w-[60px] h-[60px]"
                      src="https://via.placeholder.com/60x60"
                ...
                <div className="w-[420px] h-[141px] flex-col gap-2.5 mt-[10px] ml-[44%] inline-flex">
                  <div className="h-[17px] flex-col justify-end items-start gap-[162px] flex">
                    <div className="self-stretch justify-between items-start flex">
                      <div className="text-neutral-600 text-sm font-normal mr-[275px]">
                        Subtotal
                      </div>
                      <div className="text-neutral-600 text-sm font-normal ">
                        125.000.000đ
                  ...
                  <div className="h-[17px] flex-col justify-end items-start gap-[162px] flex">
                    <div className="self-stretch justify-between items-start flex">
                      <div className="text-black text-sm font-normal mr-[275px] font-['Inter']">
                      Total
                      </div>
          ...
          <div className={`w-[370px] p-2.5 bg-white justify-between items-start inline-flex hover:bg-lime-50 hover:text-[#71B02F] ${ isTableVisible ? 'bg-lime-50 text-[#71B02F]' : ''}`} onClick={showTable}>
            <div className="flex-col justify-start items-start gap-[5px] inline-flex">

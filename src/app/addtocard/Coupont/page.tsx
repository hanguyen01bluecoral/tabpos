...
export default function Couponts() {
  return (
    <div className="w-[470px] h-[222px] bg-white rounded-lg mx-auto">
    <div className="w-[440px] h-[39px] bg-white mx-4 mt-5 border-b-[1px] absolute flex justify-between">
      <p className="pt-2 text-black font-bold text-base">Apply coupon</p>
      <svg
    ...
    <div className="w-[440px] h-[41px]  mx-4 mt-[70px]  absolute flex justify-between">
      <p className="pt-2 text-black font-bold text-sm">Enter coupon code</p>
    </div>

    <div className="w-[440px] h-[41px] mx-4 mt-[110px]  absolute flex justify-between">
    <Input type="enter" placeholder="Enter" />
    </div>

    <div className="w-[440px] h-[41px] mx-4 mt-[165px]  absolute flex justify-between">

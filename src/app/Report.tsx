...
const ReportComponent: React.FC = () => {
  ...
  return (
    <div className="w-[570px] h-[535px] border mx-auto rounded-lg">
        <div className="w-[535px] h-[39px] bg-white mx-4 mt-5 border-b-2  absolute flex justify-between">
        ...
        <div className="w-[535px] h-[39px] bg-white mx-4 mt-[65px] border-b-2  absolute flex justify-between">
        ...
        <div className="w-[535px] h-[303px] bg-[#F7F9FB]] mx-4 mt-[145px]   absolute flex justify-between">

...
const DetailView1: React.FC<DetailViewProps> = ({ selectedItem, onSave }) => {
  ...
  return (
    <div className='w-full'>
      {selectedItem ? (
        <div className="w-full  h-screen ml-4 flex-grow mt-[140px]"> 
        <div className="w-[100%] h-[100%] bg-white flex-grow border rounded-sm flex-1">
          ...
          {/* mid */}
          <div className="w-[100%] h-[430px] overflow-y-auto scrollbar-thin">
            <div className='w-[98.4%] h-[80px] bg-[#E7F3DA] justify-between gap-2.5 inline-flex ml-5   mt-3 rounded-sm p-3'>
                <div>
                  <div className='flex'>
                    <p className='text-[16px] font-[600]'>Register One</p>
